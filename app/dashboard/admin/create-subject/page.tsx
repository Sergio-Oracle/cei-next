      ...
      <div style={{ maxWidth:900, margin:'0 auto' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:18, flexWrap:'wrap', gap:10 }}>
          ...
          <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
            <button onClick={() => router.push('/dashboard/admin/subjects')} className="btn btn-secondary" style={{ fontSize:14.5 }}>
        ...
        <div style={{ display:'flex', gap:10, justifyContent:'flex-end', flexWrap:'wrap' }}>
          ...
          <button onClick={() => router.push('/dashboard/admin/subjects')} className="btn btn-primary" style={{ fontSize:15.5 }}>
          ...
          <div style={{ background:'var(--surface)', borderRadius:14, border:'1px solid var(--border)', borderTop:'3px solid var(--primary)', boxShadow:'var(--shadow-sm)' }}>
            ...
            <form onSubmit={handleUpload} style={{ padding:24 }}>
              ...
              <div style={{ display:'flex', gap:10, paddingTop:8, borderTop:'1px solid var(--border)' }}>
                ...
                <button type="button" onClick={()=>router.push('/dashboard/admin/subjects')} className="btn btn-secondary" style={{ padding:'12px 18px' }}>
