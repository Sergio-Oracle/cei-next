    ...
    <div>
      ...
      <div className="card">
        {loading ? (
          ...
          <div key={n.id} style={{ display: 'flex', gap: 12, padding: '14px 24px',
            borderBottom: '1px solid var(--border)',
            background: n.is_read ? 'transparent' : 'var(--primary)08' }}>
            ...
            {!n.is_read && <div style={{ width: 8, height: 8, borderRadius: '50%',
