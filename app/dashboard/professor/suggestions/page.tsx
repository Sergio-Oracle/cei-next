...
export default function ProfessorSuggestionsPage() {
  ...
  // suggestions, avant génération complète du sujet (pas seulement à l'étape
  // d'aperçu final comme avant).
   ...
   * sauvegarder tout le sujet prévisualisé comme une seule entrée. Avant ce
   * correctif, "Banque" ignorait totalement la sélection de cases à cocher
   * et sauvegardait toujours tout le sujet d'un bloc, quelle que soit la
   * question cochée par le professeur juste au-dessus. */
