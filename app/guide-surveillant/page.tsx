    ...
    <>
      <style>{`
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .topbar { background:#d97706; color:white; padding:14px 32px; display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; z-index:100; box-shadow:0 2px 12px rgba(0,0,0,.2); }
        ...
        .hero-doc { background:#d97706; color:white; padding:60px 32px; text-align:center; }
        ...
        .section-header { background:#fffbeb; border-bottom:1px solid #fcd34d; padding:20px 28px; display:flex; align-items:center; gap:14px; }
      ...
      <div className="content-wrap">
        ...
        <div className="section" id="dashboard">
          ...
          <div className="section-body">
            ...
            <img className="guide-img" src="/screenshots/capture-9.jpg" alt="Tableau de bord Surveillant avec statistiques et liste des étudiants par examen" />
            <div className="feature-grid">
            ...
            <div style={{marginTop:24}}>
              <h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:12}}><i className="fas fa-exclamation-circle" style={{color:'#d97706'}} /> &nbsp;Panneau &quot;Examens en cours — Action requise&quot;</h4>
              <p style={{fontSize:17,color:'#475569'}}>Quand un examen est actif, une bannière verte apparaît en haut du tableau de bord avec un bouton <strong>&quot;Surveiller maintenant&quot;</strong>. C&apos;est votre point d&apos;entrée principal pendant un examen.</p>
            </div>
            <div style={{marginTop:20}}>
              <h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:12}}><i className="fas fa-table" style={{color:'#64748b'}} /> &nbsp;Tableau &quot;Tous mes examens assignés&quot;</h4>
              <p style={{fontSize:17,color:'#475569'}}>Le tableau liste tous vos examens avec leur statut et le nombre d&apos;étudiants dans votre groupe. Le bouton <strong>Surveiller</strong> n&apos;est actif que pour les examens <span style={{color:'#059669',fontWeight:700}}>En cours</span>.</p>
            </div>
          </div>
        </div>
        ...
        <div className="section" id="surveiller">
          ...
          <div className="section-body">
            <div className="steps">
              ...
              <div className="step"><div className="step-num">4</div><div className="step-content"><h4>Caméra secondaire (smartphone)</h4><p>Quand l&apos;examen l&apos;exige, une petite miniature du flux du téléphone de l&apos;étudiant s&apos;affiche en incrustation sur sa carte. <strong>Cliquez sur la miniature</strong> pour l&apos;agrandir et voir clairement les angles morts de son poste de travail.</p></div></div>
              <div className="step"><div className="step-num">5</div><div className="step-content"><h4>Consulter les logs d&apos;activité</h4><p>Cliquez sur le bouton <strong>&quot;Logs&quot;</strong> sur la carte d&apos;un étudiant pour voir son historique complet d&apos;événements horodatés : changements de fenêtre, alertes visage, avertissements reçus, etc.</p></div></div>
            </div>
          </div>
        </div>
        ...
        <div className="section" id="detection">
          ...
          <div className="section-body">
            ...
            <div style={{marginTop:24}}>
              <h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:12}}>Score de risque</h4>
              <p style={{fontSize:17,color:'#475569'}}>Chaque étudiant dispose d&apos;un <strong>score de risque de 0 à 100%</strong> calculé en temps réel en fonction des incidents accumulés (changements de fenêtre, absence de visage, etc.). Un étudiant avec un score ≥ 70% apparaît avec un encadré rouge dans la grille.</p>
            </div>
            <div style={{marginTop:24}}>
              <h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:12}}>Alertes en direct sur la vidéo</h4>
              <p style={{fontSize:17,color:'#475569'}}>Pour certains incidents méritant une attention immédiate — <strong>bruit ou parole prolongée</strong>, <strong>changement d&apos;onglet ou de focus</strong>, <strong>sortie du plein écran</strong>, <strong>plusieurs écrans détectés</strong> — un badge apparaît directement sur la vidéo de l&apos;étudiant concerné, en une seconde environ, sans attendre le rafraîchissement automatique de la grille. Il disparaît de lui-même après quelques secondes, mais l&apos;événement reste consultable dans les <strong>Logs</strong> de l&apos;étudiant.</p>
            </div>
          </div>
        </div>
        ...
        <div className="section" id="actions">
          ...
          <div className="section-body">
            ...
            <img className="guide-img" src="/screenshots/capture-15.jpg" alt="Vue de surveillance live avec les boutons d'action : avertir, message, bannir, enregistrer, écran, appel" />
            <div className="action-card" style={{background:'#fffbeb',borderColor:'#fcd34d'}}><div className="action-icon" style={{background:'#fef3c7',color:'#f59e0b'}}><i className="fas fa-exclamation-triangle" /></div><div><h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:4}}>Envoyer un avertissement</h4><p style={{fontSize:15.5,color:'#475569'}}>Un popup orange s&apos;affiche immédiatement sur l&apos;écran de l&apos;étudiant avec votre message. À utiliser en cas de comportement suspect (absence prolongée du visage, score de risque élevé).</p></div></div>
            <div className="action-card" style={{background:'#eff6ff',borderColor:'#bfdbfe'}}><div className="action-icon" style={{background:'#dbeafe',color:'#2563eb'}}><i className="fas fa-comment" /></div><div><h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:4}}>Envoyer un message</h4><p style={{fontSize:15.5,color:'#475569'}}>Un popup bleu s&apos;affiche sur l&apos;écran de l&apos;étudiant. Utile pour une communication discrète : lui indiquer de se repositionner devant la caméra, de partager l&apos;écran complet, etc.</p></div></div>
            <div className="action-card" style={{background:'#ecfdf5',borderColor:'#a7f3d0'}}><div className="action-icon" style={{background:'#d1fae5',color:'#059669'}}><i className="fas fa-phone" /></div><div><h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:4}}>Appel audio/vidéo privé</h4><p style={{fontSize:15.5,color:'#475569'}}>Lance un appel privé et isolé avec l&apos;étudiant. Voir la <a href="#appel" style={{color:'#059669',fontWeight:600}}>section 7</a> pour le détail.</p></div></div>
            <div className="action-card" style={{background:'#fff1f2',borderColor:'#fecdd3'}}><div className="action-icon" style={{background:'#ffe4e6',color:'#ef4444'}}><i className="fas fa-ban" /></div><div><h4 style={{fontSize:17,fontWeight:700,color:'#0f172a',marginBottom:4}}>Bannir l&apos;étudiant</h4><p style={{fontSize:15.5,color:'#475569'}}>Exclut immédiatement l&apos;étudiant de l&apos;examen (irréversible). Voir la <a href="#bannissement" style={{color:'#ef4444',fontWeight:600}}>section 8</a> pour le détail. Saisissez toujours un motif précis avant de confirmer.</p></div></div>
