    ...
    <>
      ...
      <div className="content-wrap">
        ...
        <div className="section" id="pendant">
          ...
          <div className="section-body">
            <div className="steps">
              <div className="step"><div className="step-num">1</div><div className="step-content"><h4>Lire le sujet</h4><p>Le sujet s&apos;affiche dans le panneau principal. Seules les questions sont visibles — le barème est masqué. Utilisez le bouton <strong>Réduire/Agrandir</strong> pour ajuster l&apos;affichage.</p></div></div>
