    ...
    <>
      ...
      <div className="content-wrap">
        ...
        <div className="section" id="demarrer">
          ...
          <div className="section-body">
            <div className="steps">
              ...
              <div className="step"><div className="step-num">3</div><div className="step-content"><h4>Scan de l&apos;environnement (360°)</h4><p>Avant de démarrer, il vous sera demandé de tourner lentement votre caméra pour montrer votre environnement — cela vérifie qu&apos;aucune autre personne n&apos;est présente à vos côtés. Cette étape dure quelques secondes.</p></div></div>
              <div className="step"><div className="step-num">4</div><div className="step-content"><h4>Mode plein écran</h4><p>L&apos;examen s&apos;ouvre en plein écran automatiquement. Votre caméra s&apos;active, la surveillance commence. Ne quittez pas le plein écran pendant l&apos;examen.</p></div></div>
            </div>
          </div>
        </div>
        ...
        <div className="section" id="deconnexion">
          ...
          <div className="section-body">
            <p style={{color:'#475569',marginBottom:20}}>Si vous êtes déconnecté(e) pendant un examen (fermeture accidentelle de l&apos;onglet, coupure réseau prolongée…), vous ne pouvez <strong>pas</strong> rouvrir simplement la page pour continuer — un code de reprise à usage unique est désormais exigé, pour éviter tout partage d&apos;accès entre étudiants.</p>
            <div className="steps">
              <div className="step"><div className="step-num">1</div><div className="step-content"><h4>Retour au tableau de bord</h4><p>En rouvrant l&apos;examen, un écran <strong>&quot;Code de reprise requis&quot;</strong> s&apos;affiche. Cliquez sur <strong>&quot;Retour au tableau de bord&quot;</strong>.</p></div></div>
              <div className="step"><div className="step-num">2</div><div className="step-content"><h4>Demander un appel</h4><p>Sur votre tableau de bord, une bannière <strong>&quot;Examen en cours&quot;</strong> apparaît avec un bouton <strong>&quot;Appeler mon surveillant&quot;</strong>. Cliquez dessus — un appel audio/vidéo se lance automatiquement vers votre surveillant (ou, s&apos;il n&apos;est pas disponible, votre superviseur ou votre enseignant).</p></div></div>
              <div className="step"><div className="step-num">3</div><div className="step-content"><h4>Vérification d&apos;identité</h4><p>La personne qui répond vérifie votre identité pendant l&apos;appel — c&apos;est une étape normale et obligatoire, pas une sanction.</p></div></div>
              <div className="step"><div className="step-num">4</div><div className="step-content"><h4>Saisir le code</h4><p>Une fois votre identité vérifiée, on vous communique oralement un code à 6 chiffres. Retournez sur l&apos;écran &quot;Code de reprise requis&quot; (bouton &quot;Reprendre&quot; depuis la bannière) et saisissez-le.</p><div className="warn"><i className="fas fa-exclamation-triangle" /> Ce code est <strong>à usage unique</strong> et expire après <strong>10 minutes</strong> — s&apos;il ne fonctionne plus, redemandez un appel pour en obtenir un nouveau.</div></div></div>
              <div className="step"><div className="step-num">5</div><div className="step-content"><h4>Vos réponses ne sont pas perdues</h4><p>Vos réponses précédentes sont automatiquement restaurées à la reprise, et vous retrouvez exactement là où vous vous étiez arrêté(e) — pas besoin de tout recommencer.</p></div></div>
            </div>
          </div>
        </div>
