    ...
    <>
      <style>{`
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .topbar { background:#2563eb; color:white; padding:14px 32px; display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; z-index:100; box-shadow:0 2px 12px rgba(0,0,0,.2); }
        ...
        .hero-doc { background:#2563eb; color:white; padding:60px 32px; text-align:center; }
        ...
        .section-header { background:#eff6ff; border-bottom:1px solid #bfdbfe; padding:20px 28px; display:flex; align-items:center; gap:14px; }
              ...
              <div className="step">
                ...
                <div className="step-content">
                  ...
                  <div className="feature-grid">
                    ...
                    <div className="feature-item"><i className="fas fa-mobile-screen" /><h5>Caméra secondaire (smartphone)</h5><p>Désactivée par défaut — activez-la pour exiger un second angle de vue (via le téléphone de l&apos;étudiant) en plus de la caméra de l&apos;ordinateur, utile pour couvrir le bureau et les mains. L&apos;étudiant couple son téléphone par QR code avant d&apos;accéder à l&apos;examen</p></div>
                  </div>
        ...
        <div className="section" id="dashboard">
          ...
          <div className="section-body">
            ...
            <div className="feature-grid">
              ...
              <div className="feature-item"><i className="fas fa-mobile-screen" /><h5>Caméra secondaire</h5><p>Quand activée pour l&apos;examen, une miniature du flux du téléphone apparaît en incrustation sur la carte de l&apos;étudiant — cliquez dessus pour l&apos;agrandir et voir clairement les angles morts du poste de travail</p></div>
              <div className="feature-item"><i className="fas fa-bell" /><h5>Alertes en direct sur la tuile vidéo</h5><p>Bruit/parole prolongée, changement d&apos;onglet ou de focus, plein écran quitté, plusieurs écrans : un badge apparaît directement sur la vidéo de l&apos;étudiant concerné en environ une seconde, sans attendre le rafraîchissement du dashboard. L&apos;événement reste aussi consultable en détail dans &quot;Logs&quot;</p></div>
