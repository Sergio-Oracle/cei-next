...
export default function ProctorPage() {
  ...
  // Les alertes temps réel (bannissement, risque élevé, agent autonome) sont
  // reçues via le long-polling déjà branché sur ce layout (SupervisorCallListener)
  // et rafraîchissent cette liste ; ce composant se resynchronise en plus toutes
  // les 8 s ci-dessus.
